For this week, I did use chatgpt to help with some minor adjustments with text, but I predominantly used the example file. I could do a lot of the assignment using a CDN, 
